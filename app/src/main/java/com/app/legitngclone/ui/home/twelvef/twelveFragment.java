package com.app.legitngclone.ui.home.twelvef;
...
public class twelveFragment extends Fragment {
    ...
    private TwelveFragmentViewModel twelveFragmentViewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        twelveFragmentViewModel =
                ViewModelProviders.of(this).get(TwelveFragmentViewModel.class);
        twelveFragmentViewModel.getPosts(page,limit);
        ...
        twelveFragmentViewModel.postMutableLiveData.observeForever(new Observer<List<PostModel>>() {
            @Override
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                twelveFragmentViewModel.postMutableLiveData.observe((LifecycleOwner) getContext(), new Observer<List<PostModel>>() {
                    @Override
                    public void onChanged(List<PostModel> postModels) {
                        progressBar.setVisibility(View.GONE);
                        postsAdapter.setmContext(getContext());
