package com.app.legitngclone.ui.home.twof;
...
public class twoFragment extends Fragment {
    ...
    private TwoFragmentViewModel twoFragmentViewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        twoFragmentViewModel =
                ViewModelProviders.of(this).get(TwoFragmentViewModel.class);
        twoFragmentViewModel.getPosts(page,limit);
        ...
        twoFragmentViewModel.postMutableLiveData.observeForever(new Observer<List<PostModel>>() {
            @Override
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                twoFragmentViewModel.postMutableLiveData.observe((LifecycleOwner) getContext(), new Observer<List<PostModel>>() {
                    @Override
                    public void onChanged(List<PostModel> postModels) {
                        progressBar.setVisibility(View.GONE);
                        postsAdapter.setmContext(getContext());
